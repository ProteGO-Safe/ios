...
def crashlytics
  ...
  #  pod 'Firebase/Crashlytics', '6.22.0', :configurations => ['Debug_dev', 'Release_dev']
 pod 'Firebase', '6.22.0', :configurations => ['Debug_dev', 'Release_dev']
 pod 'FirebaseAnalyticsInterop', '1.5.0', :configurations => ['Debug_dev', 'Release_dev']
 pod 'FirebaseCore', '6.6.6', :configurations => ['Debug_dev', 'Release_dev']
 pod 'FirebaseCoreDiagnostics', '1.2.3', :configurations => ['Debug_dev', 'Release_dev']
 pod 'FirebaseCoreDiagnosticsInterop', '1.2.0', :configurations => ['Debug_dev', 'Release_dev']
 pod 'FirebaseCrashlytics', '4.0.0-beta.7', :configurations => ['Debug_dev', 'Release_dev']
 pod 'FirebaseInstallations', '1.1.1', :configurations => ['Debug_dev', 'Release_dev']
 pod 'GoogleDataTransport', '5.1.1', :configurations => ['Debug_dev', 'Release_dev']
 pod 'GoogleDataTransportCCTSupport', '2.0.2', :configurations => ['Debug_dev', 'Release_dev']
 ...
 pod 'FirebaseAnalytics', '6.4.1', :configurations => ['Debug_dev', 'Release_dev']
 pod 'GoogleAppMeasurement', '6.4.1', :configurations => ['Debug_dev', 'Release_dev']
