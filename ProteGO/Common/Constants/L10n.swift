...
internal enum L10n {
  /// Ograniczenia w przemieszczaniu się z wyjątkiem drogi do pracy, wolontariatu, załatwiania spraw niezbędnych do życia codziennego.
  internal static let dashboardGreenRecommend1 = L10n.tr("Localizable", "dashboard_green_recommend_1")
  /// W autobusie może być tyle osób ile wynosi połowa liczby miejsc siedzących.
  ...
  /// Przebywałeś w miejscach lub blisko osób, u których wykryto koronawirusa. Poddaj się domowej kwarantannie. Zadzwoń do najbliższego GIS. 
  internal static let dashboardRedStatusDescription = L10n.tr("Localizable", "dashboard_red_status_description")
  /// Byłeś w strefies zagrożenia!
  ...
  /// Aby aplikacja mogła działać prawidłowo, Bluetooth na Twoim telefonie musi być włączony cały czas.\n\nDzięki połączeniu Bluetooth ProteGO skanuje otoczenie w poszukiwaniu innych użytkowników, którzy korzystają z aplikacji.\n\nInformacje o napotkanych urządzeniach są przechowywane tylko na Twoim telefonie i nie są nigdzie wysyłane.
  ...
  /// Zgłoś się do najbliższego ośrodka GIS
  ...
  /// Mogłeś przebywać wśród osób zarażonych
  ...
  /// Potrzebujemy Twojego numeru telefonu, aby móc się z Tobą skontaktować jeśli byłeś w pobliżu osób zarażonych.\n\nPotwierdzimy Twój numer przesyłając Ci kod weryfikacyjny SMSem.
  ...
  /// Dołączając do aplikacji, akceptujesz %@.
  ...
  /// Wpisz swój kod, który otrzymałeś w SMSie wysłanym na numer
  ...
  /// Twoje dane zostały przekazane do Głównego Inspektoratu Sanitarnego.\nZapewniamy, że żadne osoby, którym ewentualnie się skontaktujemy nie poznają Twoich danych osobowych.\n\nW razie jakichkolwiek pytań napisz do nas na %@\nlub zadzwoń %@
  ...
  /// Podziel się informacją o osobach, które były w pobliżu Ciebie w ciągu ostatnich dwóch tygodni, abyśmy mogli ostrzec je przed ewentualnym zarażeniem.\n\nNikt nie dowie się o Twojej chorobie.
