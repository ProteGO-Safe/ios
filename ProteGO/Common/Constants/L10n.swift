...
internal enum L10n {
  ...
  /// You need to be connected to the Internet to use the application. Turn on the WiFi or data connection to continue.
  ...
  /// You need to upgrade the application to the latest version. Press "Upgrade" and follow the further instructions.
